#!/bin/bash 
. venv/bin/activate
python3 ./neurons/miner.py --subtensor.network local --wallet.name my_coldkey --wallet.hotkey my_third_hotkey --neuron.scraping_config_file ./scraping/config/miner_11301.json --axon.port 9702 --axon.max_workers 16 --logging.trace --logging.debug
