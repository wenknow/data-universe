#!/bin/bash 
. venv/bin/activate
python3 ./neurons/miner.py --offline --wallet.name my_coldkey --wallet.hotkey my_first_hotkey --neuron.scraping_config_file ./scraping/config/miner_11301.json --axon.port 21302 --logging.trace --logging.debug
