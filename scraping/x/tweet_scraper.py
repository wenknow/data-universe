...
class TweetScraper(Scraper):
    ...
    async def validate(self, entities: List[DataEntity]) -> List[ValidationResult]:
        ...
        with TweetScraper.concurrent_validates_semaphore:
            bt.logging.trace(
    ...
    async def scrape(self, scrape_config: ScrapeConfig) -> List[DataEntity]:
        ...
        startUrl = "https://twitter.com/search?q={query}&src=typed_query&f=live"
        ...
        run_config = RunConfig(
            ...
            timeout_secs=TweetScraper.SCRAPE_TIMEOUT_SECS,
        )
    ...
    def _best_effort_parse_dataset(self, dataset: List[dict]) -> List[XContent]:
        ...
        for data in dataset:
            try:
                ...
                if (
                    ("text" not in data and "truncated_full_text" not in data)
